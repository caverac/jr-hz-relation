...
def make_all_figures() -> dict[str, Figure]:
    """Build and save the full analytic figure set to ``assets/figures``.

    The test-particle figure is excluded: it is driven by a cached, expensive
    orbit-integration store and is generated by its own command.
